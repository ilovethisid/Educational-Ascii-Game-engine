...
{
    Matrix M1 = console_.makeFile2Matrix("C:\\Users\\정훈석\\Desktop\\깃헙 소공\\Educational-Ascii-Game-engine\\Graphic\\enemy1");
    Matrix M2 = console_.makeFile2Matrix("C:\\Users\\정훈석\\Desktop\\깃헙 소공\\Educational-Ascii-Game-engine\\Graphic\\enemy2");
    Matrix M3 = console_.makeFile2Matrix("C:\\Users\\정훈석\\Desktop\\깃헙 소공\\Educational-Ascii-Game-engine\\Graphic\\enemy3");
    MV.push_back(M1);
    MV.push_back(M2);
    MV.push_back(M3);
}
